...
import { AdminLessonItemsSortable } from './AdminLessonItem';
  ...
  function handleDragEnd(event: DragEndEvent) {
    ...
    if (active.id !== over.id) {
      setItems((items) => {
        ...
        const newUpItem = newItem[newIndex - 1]?.rank;
        const newDownItem = newItem[newIndex + 1]?.rank;
